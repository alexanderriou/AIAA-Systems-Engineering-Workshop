...
public class SysML2Lexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"T__0", "T__1", "T__2", "T__3", "T__4", "T__5", "T__6", "KW_ABOUT", "KW_ACTOR", 
			...
			"REAL", "BOOL", "STRING", "MULTIPLICITY", "ESC", "UNICODE", "HEX", "NULL", 
	...
	public SysML2Lexer(CharStream input) {
		super(input);
